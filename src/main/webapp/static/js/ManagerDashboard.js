document.addEventListener("DOMContentLoaded", function () {
  fetch("../static/data/data.json")
    ...
    .then((data) => {
      const meetingsContainer = document.querySelector(
        ".meetings-container .container"
      );
      ...
      data.meetings.forEach((meeting) => {
        ...
        // Populate the meeting div with the necessary HTML and data
        ...
        // Append the meeting div to the container
